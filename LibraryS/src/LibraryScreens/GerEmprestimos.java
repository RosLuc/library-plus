 ...
 * @author death
 */
public class GerEmprestimos extends Application {
    ...
    public void start(Stage stage) throws Exception {
        Parent root = FXMLLoader.load(getClass().getResource("/View/GerEmprestimos.fxml")); //carrega o FXML
