 ...
 * @author death
 */
public class AtualizarMaterial extends Application {
    ...
    public void start(Stage stage) throws Exception {
        Parent root = FXMLLoader.load(getClass().getResource("/View/AtualizarMaterial.fxml")); //carrega o FXML
