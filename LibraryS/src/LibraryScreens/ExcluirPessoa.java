 ...
 * @author death
 */
public class ExcluirPessoa extends Application {
    ...
    public void start(Stage stage) throws Exception {
        Parent root = FXMLLoader.load(getClass().getResource("/View/ExcluirPessoa.fxml")); //carrega o FXML
