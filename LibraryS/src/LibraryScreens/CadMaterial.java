 ...
 * @author death
 */
public class CadMaterial extends Application {
    ...
    public void start(Stage stage) throws Exception {
        Parent root = FXMLLoader.load(getClass().getResource("/View/CadMaterial.fxml")); //carrega o FXML
