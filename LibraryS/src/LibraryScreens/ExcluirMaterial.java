 ...
 * @author death
 */
public class ExcluirMaterial extends Application {
    ...
    public void start(Stage stage) throws Exception {
        Parent root = FXMLLoader.load(getClass().getResource("/View/ExcluirMaterial.fxml")); //carrega o FXML
