 ...
 * @author death
 */
public class RealizarEmp extends Application {
    ...
    public void start(Stage stage) throws Exception {
        Parent root = FXMLLoader.load(getClass().getResource("/View/RealizarEmp.fxml")); //carrega o FXML
