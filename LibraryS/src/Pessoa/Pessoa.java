...
/**
 * Classe para objetos do tipo Pessoa, onde serão contidos, valores e métodos
 * para o mesmo.
 *
 * @author Lucas
 * @version 1.5
...
public class Pessoa {
    ...
    /**
     * Método contrutor da classe Pessoa. Responsavel por inicializar o objeto.
     */
    public Pessoa() {
    }

    /**
     * Método contrutor completo da classe Pessoa. Responsavel por inicializar o
     * objeto e todos seus metodos.
     *
     ...
     *
     * @return Caso ativos menor que 5 é retornado número de vagas, caso ativos
     * maior que 5 é retornado 0, caso objeto seja null é retornado -1.
     */
    public int verificarLimite() {
        if (this != null) {
            if (this.getAtivos() < 5) {
                return (5 - this.getAtivos());
            } else {
                return 0;
            }
        } else {
     ...
     *
     * @return Caso operação seja realizada com sucesso retorna true, caso
    ...
    /**
     * Método que responsavel por acrescentar um valor x do total de
     * emprestimos.
     *
     * @param x
     * @return Caso operação seja realizada com sucesso retorna true, caso
     ...
     *
     * @return List - Caso a operação for realizada com sucesso retorna uma
     * lista de pessoa, caso contrário retorna null.
     */
    ...
    /**
     * Metodo responsável por excluir o objeto pessoa do banco de dados. A
     * operação é realizada utilizando hibernate.
     *
     * @return boolean - Caso a operação for realizada com sucesso retorna true,
     * caso contrário retorna false.
    ...
    /**
     * Metodo responsável por buscar o objeto pessoa salvo no banco de dados
     * pelo codinsc. A operação é realizada utilizando hibernate.
     *
    ...
    /**
     * Metodo responsável por filtrar uma lista dos objetos pessoa salvos no
     * banco de dados. A operação é realizada utilizando hibernate.
     *
     * @return List - Caso a operação for realizada com sucesso retorna uma
     * lista de pessoa, caso contrário retorna null.
     */
